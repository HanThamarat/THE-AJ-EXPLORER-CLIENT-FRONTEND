        ...
        <div className="w-full flex justify-center items-center p-[20px] rounded-[20px] bg-white">
            <div className="flex items-center gap-[10px]">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <span className={`mt-[4px] text-[#495AFF]`}>Customer Info</span>
                </div>
                <div className="flex items-start">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <span className={`mt-[4px] ${ steps >= 2 ? 'text-[#495AFF]' : 'text-[#CFD6DC]' }`}>Payment info</span>
                    </div>
                </div>
                <div className="flex items-start">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <span className={`mt-[4px] ${ steps >= 3 ? 'text-[#495AFF]' : 'text-[#CFD6DC]' }`}>Booking is confirmed</span>
                    </div>
                </div>
            </div>
        </div>
